...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h2>${variables.role == null ? "Grand Mage" : variables.role}</h2>
          <h3>${variables.city == null ? "Narnia" : variables.city}, 
          ${variables.country == null ? "The Wardrobe" : variables.country}</h3>
